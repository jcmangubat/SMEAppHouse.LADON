...
public class BlogPostCommentConfiguration(string schema = "dbo")
    : EntityConfiguration<BlogPostComment, Guid>(prefixEntityNameToId: true,
        prefixAltTblNameToEntity: false, schema: schema, pluralizeTblName: true)
{
    public override void OnModelCreating(EntityTypeBuilder<BlogPostComment> entityBuilder)
    {
