...
public class BlogPostImageConfiguration(string schema = "dbo", ModelBuilder builder = null)
    : EntityConfiguration<BlogPostImage, Guid>(builder, prefixEntityNameToId: true,
        prefixAltTblNameToEntity: false, schema: schema, pluralizeTblName: true)
{
    ...
    public override void OnModelCreating(EntityTypeBuilder<BlogPostImage> entityBuilder)
    {
