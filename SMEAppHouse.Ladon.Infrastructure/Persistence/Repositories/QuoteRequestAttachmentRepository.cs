...
public class QuoteRequestAttachmentRepository(ApplicationDbContext dbContext)
    : EntityRepositoryForKeyedEntity<QuoteRequestAttachment>(dbContext), IQuoteRequestAttachmentRepository
{
}
