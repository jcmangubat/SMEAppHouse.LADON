...
public class ArticleCategoryRepository(ApplicationDbContext dbContext)
    : EntityRepositoryForKeyedEntity<ArticleCategory>(dbContext), IArticleCategoryRepository
{
}
